...
draft: false
---
<p>Preset Mutator is live on Kreativ Sound as one browser tool with three Vital workflows: From Scratch, Mutate Preset, and Audio to Preset.</p>
        <p>Vital is the first supported format. Serum 2 and Arturia Pigments 7 are planned as future synth targets once the current workflow is stable.</p>
