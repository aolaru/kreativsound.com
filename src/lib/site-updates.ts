...
export const siteUpdates: SiteUpdate[] = [
  ...
  { date: "2026-08-21", kind: "update", title: "Wave Mutator beta v0.2.1", description: "Four local Delivery Profiles now set practical cleanup, export, naming, pack, and preview defaults for sample packs, music, game SFX, and store previews.", href: "/tools/wave-mutator/changelog/" },
