...
export const siteUpdates: SiteUpdate[] = [
  ...
  { date: "2026-08-28", kind: "update", title: "Preset Mutator Lite v0.4.6", description: "The Lite generator now starts from more distinct Vital structures and responds more closely to selected and audio-source directions.", href: "/preset-mutator/changelog/" },
  { date: "2026-08-25", kind: "update", title: "Pattern Mutator Lite adds free piano roll editing", description: "Generated MIDI ideas can now be edited directly: add, move, resize, adjust velocity, delete notes, then export the finished clip for any DAW.", href: "/tools/pattern-mutator/" },
  { date: "2026-08-25", kind: "update", title: "Pattern Mutator Lite changelog added", description: "The new free MIDI idea generator now has a versioned public changelog linked from its footer, starting with its launch features and future improvements.", href: "/tools/pattern-mutator/changelog/" },
  { date: "2026-08-25", kind: "new", title: "Pattern Mutator Lite first draft released", description: "A free browser tool now generates scale-aware MIDI melodies, basslines, chords, and arpeggios, with locks, mutation, audition, and MIDI export.", href: "/tools/pattern-mutator/" },
  ...
  { date: "2026-08-22", kind: "update", title: "Preset Mutator Lite v0.4.2", description: "A public changelog now records Lite workflow improvements and fixes, with direct links from every mode.", href: "/preset-mutator/changelog/" },
  { date: "2026-08-21", kind: "update", title: "Wave Mutator Lite beta v0.2.1", description: "Four local Delivery Profiles now set practical cleanup, export, naming, pack, and preview defaults for sample packs, music, game SFX, and store previews.", href: "/tools/wave-mutator/changelog/" },
  ...
  { date: "2026-08-21", kind: "update", title: "Preset Mutator Lite v0.4.1", description: "The Lite Vital workflow creates three downloadable variants per run with no account or purchase required.", href: "/tools/preset-mutator/" },
  { date: "2026-08-20", kind: "new", title: "Public Updates log added", description: "Kreativ Sound now keeps a dedicated public record of visitor-visible catalog, tool, site, and reliability changes.", href: "/updates/", audience: "maintenance" },
  { date: "2026-08-20", kind: "release", title: "Wave Mutator Lite beta v0.2.0", description: "Wave Mutator Lite supports cleaner WAV workflows, ZIP pack export, and locally encoded MP3 preview montages.", href: "/tools/wave-mutator/" },
  ...
  { date: "2026-08-20", kind: "fix", title: "Deployment validation strengthened", description: "Pull requests now validate the full site before merge, while production deploys run only after the same quality checks pass.", href: "/updates/", audience: "maintenance" },
  { date: "2026-08-19", kind: "fix", title: "Analytics unified across the site", description: "The production build now uses the same Google Analytics setup across the main site and browser tools, alongside Cloudflare Web Analytics.", href: "/privacy/", audience: "maintenance" },
  ...
  { date: "2026-08-19", kind: "update", title: "Updates and deployment checks refreshed", description: "Release notes became easier to browse, and the build pipeline gained faster dependency and readiness handling.", href: "/updates/", audience: "maintenance" },
  { date: "2026-08-18", kind: "fix", title: "Site quality and analytics coverage improved", description: "Metadata, internal links, thumbnails, product data, search, and browser-tool routes gained broader automated checks.", href: "/privacy/", audience: "maintenance" },
  ...
  { date: "2026-07-15", kind: "fix", title: "SEO, performance, and Pages delivery repaired", description: "Site metadata, route handling, thumbnail checks, and GitHub Pages deployment visibility were improved for more dependable publishing.", href: "/", audience: "maintenance" },
  ...
  { date: "2026-06-18", kind: "new", title: "Wave Mutator Lite beta announced", description: "The browser-based WAV preparation tool launched alongside clearer Lite-versus-PRO comparisons for preset releases.", href: "/tools/" },
  { date: "2026-06-18", kind: "update", title: "Cloudflare Web Analytics enabled", description: "Aggregate traffic and performance measurement was added site-wide with the related privacy information updated.", href: "/privacy/", audience: "maintenance" },
  ...
  { date: "2026-04-28", kind: "update", title: "Website rebuilt with Astro and GitHub Pages", description: "The catalog, product details, content pages, site search, and publishing flow moved to the current static website architecture.", href: "/", audience: "maintenance" },
