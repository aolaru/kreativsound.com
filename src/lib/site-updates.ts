...
export const siteUpdates: SiteUpdate[] = [
  ...
  { date: "2026-08-20", kind: "update", title: "Preset Mutator is now fully free", description: "The Vital preset browser tool now creates three downloadable variants per run with no purchase flow or account requirement.", href: "/tools/preset-mutator/" },
  ...
  { date: "2026-08-19", kind: "update", title: "News and deployment checks refreshed", description: "News now surfaces recent release notes more clearly, and the build pipeline has faster dependency and readiness handling.", href: "/news/" },
  ...
  { date: "2026-07-21", kind: "update", title: "Guides moved into News", description: "The separate Learn area now points visitors to the combined News and Guides experience, keeping release context and practical workflows together.", href: "/news/" },
