...
export function applyParameterMapToPreset(seedData, preset) {
  ...
  settings.osc_1_on = 1;
  settings.osc_2_on = 1;
  settings.osc_3_on = settings.osc_3_on ? 1 : 0;
  settings.sample_on = 0;
  settings.sample_level = 0;
  settings.filter_2_on = 0;
  settings.filter_1_on = 1;
  settings.flanger_dry_wet = clamp(settings.flanger_dry_wet || 0, 0, 0.16);
  settings.phaser_dry_wet = clamp(settings.phaser_dry_wet || 0, 0, 0.16);
  ...
  settings.flanger_on = settings.flanger_dry_wet > 0.01 ? 1 : 0;
  settings.phaser_on = settings.phaser_dry_wet > 0.01 ? 1 : 0;
